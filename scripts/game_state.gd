...
const STARTER_DECK = ["meteor_shower", "meteor_shower", "energize", "energize", "energy_shield", "energy_shield", "zap", "zap"]
...
const DRAFT_POOL = ["ice_cannon", "energize", "zap", "meteor_shower"]

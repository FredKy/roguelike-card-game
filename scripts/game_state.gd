...
const STARTER_DECK = ["meteor_shower", "meteor_shower", "energize", "energize", "ice_barrier", "ice_barrier", "zap", "zap"]
...
const DRAFT_POOL = ["ice_cannon", "energize", "zap", "meteor_shower", "ice_barrier"]
